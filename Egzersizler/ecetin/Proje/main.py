...
yol = r"Egzersizler/ecetin/Proje/db/chinook.db"
db = DBTool(yol)
...
LEFT JOIN tracks as tr ON alb.albumid = tr.albumid LIMIT 20"""
sonuclar = db.sorgu(sorgu)

for item in sonuclar:
    data = {"trackid":item[0],"name":item[1],"album":item[2],"artists":item[3]}
    print(nosqldb.insert(data),file=open("Egzersizler/ecetin/Proje/log.csv","a"))